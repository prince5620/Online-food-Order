                                                ...
                                                <ul class="list-unstyled">
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio m-b-10">
                                                            <input name="mod" type="radio" value="paypal" enable class="custom-control-input"> <span class="custom-control-indicator"></span> <span class="custom-control-description">Paypal <img src="images/paypal.jpg" alt="" width="90"></span>
                                                        </label>
                                                    </li>
                                                </ul>
                                                <p class="text-xs-center"> <input type="submit" onclick="return confirmOrder();" name="submit" class="btn btn-success btn-block" value="Order Now">
                                                </p>
                                            </div>

                                            <script>
                                                function confirmOrder() {
                                                    var paymentOption = document.querySelector('input[name="mod"]:checked')
                                                        .value;
                                                    if (paymentOption === "paypal") {
                                                        // Redirect to PayPal payment link
                                                        window.location.href =
                                                            "https://rzp.io/i/Sp9xc3tw"; // Replace this URL with your PayPal payment link
